...
function AdminCard({ product, setFormAction, setForm }: IAdminProductItem) {
    ...
    return (
        <div className='admin-card'>
            ...
            <Button handlerClick={editProductHandler} styleClass="button" text='Изменить' />

            <Button handlerClick={deleteProductHandler} styleClass="button button__circle admin-card__button" picture={<svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
