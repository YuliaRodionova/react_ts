...
function Product(props: IProduct): JSX.Element {
    const { img, weightIcon, weight, unit, brand, productName, code, producer, price, available, articleNumber, purpose, productType, boxSize, quantityInBox } = props;
    ...
    return (
        <div>
            ...
            <Button styleClass="button button__bg-white" text="При покупке от 10 000 ₸ бесплатная доставка по Кокчетаву и области" />
            ...
            <Details title="Описание" description="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam interdum ut justo, vestibulum sagittis iaculis iaculis. Quis mattis vulputate feugiat massa vestibulum duis. Faucibus consectetur aliquet sed pellentesque consequat consectetur congue mauris venenatis. Nunc elit, dignissim sed nulla ullamcorper enim, malesuada." />
            <Details title="Характеристики" description="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam interdum ut justo, vestibulum sagittis iaculis iaculis. Quis mattis vulputate feugiat massa vestibulum duis. Faucibus consectetur aliquet sed pellentesque consequat consectetur congue mauris venenatis. Nunc elit, dignissim sed nulla ullamcorper enim, malesuada." />
