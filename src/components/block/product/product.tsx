...
function Product(props: IProduct): JSX.Element {
    ...
    return (
        <>
            <BreadCrumbs linkUrl="/Catalogue" classDashed="right-border-dashed" linkTitle={`${brand} ${productName} ${weight}${unit}`} />
            <CircleButtonBack />
            <div className="product">
                <div className="product__img-wrap">
                    <img className="product__img" src={img} alt={productName} />
                </div>
                <div className="product__wrapper">
                    ...
                    <div className="product__item">
                        ...
                        <CartButton styleClass="product__cart-button" productCartItem={toCart} />
                        <Button styleClass="button button__bg-white product__share-button" picture={<svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <button className="button button__bg-white button_wrap product__delivery-button">При покупке от <span className="product__delivery-button_bold">10 000 ₸</span> бесплатная доставка по Кокчетаву и области</button>
                        <PriceList styleClassForLink="button button__bg-white button_gray-icon product__price-list" />
                    </div>
